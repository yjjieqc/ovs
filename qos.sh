...
ovs-vsctl set port eth1 qos=@newqos -- \
       --id=@newqos create qos type=linux-htb \
           ...
           queues:111=@q0 \
           queues:222=@q1 -- \
       --id=@q0 create queue other-config:min-rate=3000000000 other-config:max-rate=10000000000 -- \
       --id=@q1 create queue other-config:min-rate=3000000000 other-config:max-rate=10000000000
